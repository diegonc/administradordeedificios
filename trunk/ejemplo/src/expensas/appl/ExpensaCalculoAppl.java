...
public class ExpensaCalculoAppl {

	private Session session;
	
	public ExpensaCalculoAppl() {
	...
	public List<GastoDTO> obtenerGastosOrdinariosPorEdificioYPeriodo(int idEdificio,Periodo periodo){
		Query query = session.createQuery("select gr from GastoRealDTO gr where gr.fechaPago " +
							"between :fechaInicio and :fechaFin and gr.edificio =:idEdificio" +
							" and gr.tipoGasto.tipo <> 'EXT' ");
