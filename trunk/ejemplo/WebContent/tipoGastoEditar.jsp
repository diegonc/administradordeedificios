...
<%@page import="gastos.dto.TipoGastoDTO"%><jsp:include page="/WEB-INF/jspf/header.jspf"></jsp:include>
			...
			<fieldset>
		  		<legend>Modificacion</legend>
			 		...
			 		<table border="0" cellpadding="0" cellspacing="0">
			 			...
			 			<tr>
				 			<td width="120" align="right"><label for="tipoGasto.codigo">Codigo:</label> </td>
				 			<td colspan="4" >&nbsp;&nbsp;<input type="text" id="tipoGasto.codigo" name="tipoGasto.codigo" value=<%=tipoGasto.getCodigo()%> /><font color="red">*&nbsp;&nbsp;</font></td>
				 		</tr>
				 		<tr>
				 			<td align="right"><label for="tipoGasto.descripcion">Descripci&oacute;n:</label> </td>
				 			<td colspan="4">&nbsp;&nbsp;<input type="text" id="tipoGasto.descripcion" name="tipoGasto.descripcion" value="<%=tipoGasto.getDescripcion()%>" /><font color="red">*&nbsp;&nbsp;</font></td>
			 			</tr>
			 			<tr><td colspan="5" height="10"></td></tr>
