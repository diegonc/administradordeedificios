...
(
  ...
  CODIGO_TIPO_GASTO VARCHAR(45) NOT NULL ,
  ID_EDIFICIO INTEGER NOT NULL ,
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (ID),
  CONSTRAINT GASTO_TIPO_GASTO_FK1 FOREIGN KEY (CODIGO_TIPO_GASTO) REFERENCES TIPO_GASTO (CODIGO),
  CONSTRAINT GASTO_EDIFICIO_FK2 FOREIGN KEY (ID_EDIFICIO) REFERENCES EDIFICIO (ID)
);
CREATE INDEX GASTO_TIPO_GASTO_FK1 ON GASTO (CODIGO_TIPO_GASTO ASC);
...
(
  ...
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (ID) ,
  CONSTRAINT GASTO_REAL_FK1 FOREIGN KEY (ID)  REFERENCES GASTO (ID)
);
CREATE UNIQUE INDEX GASTO_REAL_UQ1 ON GASTO_REAL (FECHA_PAGO ASC, NRO_FACTURA_PAGO ASC, FORMA_PAGO ASC);
CREATE INDEX GASTO_REAL_FK1 ON GASTO_REAL (ID ASC);
...
(
  ...
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (ID) ,
  CONSTRAINT GASTO_PREVISION_FK1  FOREIGN KEY (ID)  REFERENCES GASTO (ID)
);
CREATE INDEX GASTO_PREVISION_FK1 ON GASTO_PREVISION (ID ASC);
...
(
  ...
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (CODIGO) ,
  CONSTRAINT TIPO_GASTO_ORDINARIO_FK1  FOREIGN KEY (CODIGO)  REFERENCES TIPO_GASTO (CODIGO)
);
CREATE INDEX TIPO_GASTO_ORDINARIO_FK1 ON TIPO_GASTO_ORDINARIO (CODIGO ASC);
...
(
  ...
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (CODIGO) ,
  CONSTRAINT TIPO_GASTO_PERIODICO_FK1  FOREIGN KEY (CODIGO)  REFERENCES TIPO_GASTO_ORDINARIO(CODIGO),
  CONSTRAINT TIPO_GASTO_PERIODICO_EDIFICIO_FK2  FOREIGN KEY (ID_EDIFICIO)  REFERENCES EDIFICIO(ID)
);
CREATE INDEX TIPO_GASTO_PERIODICO_FK1 ON TIPO_GASTO_PERIODICO (CODIGO ASC) ;
...
(
  ...
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (CODIGO) ,
  CONSTRAINT TIPO_GASTO_MONTO_FIJO_FK1  FOREIGN KEY (CODIGO)  REFERENCES TIPO_GASTO_PERIODICO (CODIGO)
);
CREATE INDEX TIPO_GASTO_MONTO_FIJO_FK1 ON TIPO_GASTO_MONTO_FIJO (CODIGO ASC);
...
(
  ...
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (CODIGO) ,
  CONSTRAINT TIPO_GASTO_MONTO_VARIABLE_FK1  FOREIGN KEY (CODIGO)  REFERENCES TIPO_GASTO_PERIODICO (CODIGO)
);
CREATE INDEX TIPO_GASTO_MONTO_VARIABLE_FK1 ON TIPO_GASTO_MONTO_VARIABLE (CODIGO ASC);
...
(
  ...
  CONSTRAINT TIPO_PROPIEDAD_TIPO_GASTO_FK2  FOREIGN KEY (CODIGO_TIPO_GASTO)  REFERENCES TIPO_GASTO (CODIGO)
);
CREATE UNIQUE INDEX TIPO_PROPIEDAD_TIPO_GASTO_UQ1 ON TIPO_PROPIEDAD_TIPO_GASTO (ID_TIPO_PROPIEDAD ASC, CODIGO_TIPO_GASTO ASC);
CREATE INDEX TIPO_PROPIEDAD_TIPO_GASTO_FK1 ON TIPO_PROPIEDAD_TIPO_GASTO (ID_TIPO_PROPIEDAD ASC);
CREATE INDEX TIPO_PROPIEDAD_TIPO_GASTO_FK2 ON TIPO_PROPIEDAD_TIPO_GASTO (CODIGO_TIPO_GASTO ASC);
...
(
  ...
  VERSION INTEGER NOT NULL,
  PRIMARY KEY (ID) ,
  CONSTRAINT EXPENSA_LIQUIDACION_FK1  FOREIGN KEY (ID)  REFERENCES EXPENSA (ID)
);
CREATE INDEX EXPENSA_LIQUIDACION_FK1 ON EXPENSA_LIQUIDACION (ID ASC);
...
(
  ...
  PRIMARY KEY (ID) ,
  VERSION INTEGER NOT NULL,
  CONSTRAINT EXPENSA_COBRO_FK1  FOREIGN KEY (ID)  REFERENCES EXPENSA (ID)
);
CREATE INDEX EXPENSA_COBRO_FK1 ON EXPENSA_COBRO (ID ASC);
