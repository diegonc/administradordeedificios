...
CREATE TABLE USUARIO_PERFIL_EDIFICIO (
  ...
  CONSTRAINT USUARIO_PERFIL_FK3 FOREIGN KEY (ID_EDIFICIO) REFERENCES PERFIL(ID),
  PRIMARY KEY (ID)
) ENGINE = InnoDB;
CREATE UNIQUE INDEX USUARIO_PERFIL_UQ1 ON USUARIO_PERFIL (ID_USUARIO ASC, ID_PERFIL ASC, ID_EDIFICIO ASC);